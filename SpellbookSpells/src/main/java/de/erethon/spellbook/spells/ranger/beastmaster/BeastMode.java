...
public class BeastMode extends RangerPetBaseSpell {
    ...
    public boolean onCast() {
        ...
        caster.getWorld().playSound(caster.getLocation(), Sound.ENTITY_WOLF_ANGRY_GROWL, 1, 1);
        pet.remove();
    ...
    protected void onTickFinish() {
        ...
        caster.getWorld().playSound(caster.getLocation(), Sound.ENTITY_WOLF_ANGRY_GROWL, 1, 0.5f);
        petTrait.spawn();
    }
